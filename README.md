...
| Splash                  | Login                  | Signup                 | Home Screen            | Product Details         | Profile                  |
|-------------------------|------------------------|------------------------|------------------------|-------------------------|-------------------------|
| ![](./screenshots/splash.gif) | ![](./screenshots/login.png) | ![](./screenshots/signup.png) | ![](./screenshots/home.png) | ![](./screenshots/details.png) | ![](./screenshots/profile.pngs) |
